...
export SRC_LOCATION=${HOME}/vectrum.cdt/src
export OPT_LOCATION=${HOME}/vectrum.cdt/opt
export VAR_LOCATION=${HOME}/vectrum.cdt/var
export ETC_LOCATION=${HOME}/vectrum.cdt/etc
export BIN_LOCATION=${HOME}/vectrum.cdt/bin
export DATA_LOCATION=${HOME}/vectrum.cdt/data
...
if [ ! -d "${REPO_ROOT}/.git" ]; then
   ...
   printf "Please clone a new VECTRUM directory with 'git clone https://github.com/vectrum-core/vectrum --recursive'\\n"
   exit 1
fi
...
printf "\\n================================================================================\\n"
printf "========================== Starting VECTRUM.CDT Build ==========================\\n"

$CMAKE -DCMAKE_INSTALL_PREFIX=${HOME}/vectrum.cdt "${REPO_ROOT}"
if [ $? -ne 0 ]; then exit -1; fi
make -j$CORES
if [ $? -ne 0 ]; then exit -1; fi

TIME_END=$(( $(date -u +%s) - $TIME_BEGIN ))
printf "\n${bldred}  __      __    ______      _____     _______     _____      _    _     __  __  \n"
printf "  \ \    / /   |  ____|    / ____|   |__   __|   |  __ \    | |  | |   |  \/  | \n"
printf "   \ \  / /    | |__      | |           | |      | |__) |   | |  | |   | \  / | \n"
printf "    \ \/ /     |  __|     | |           | |      |  _  /    | |  | |   | |\/| | \n"
printf "     \  /      | |____    | |____       | |      | | \ \    | |__| |   | |  | | \n"
printf "      \/       |______|    \_____|      |_|      |_|  \_\    \____/    |_|  |_| \n\n${txtrst}"
printf "                                                                                \n"
printf "================================================================================\n"
printf "\\nVECTRUM.CDT has been successfully built. %02d:%02d:%02d\\n\\n" $(($TIME_END/3600)) $(($TIME_END%3600/60)) $(($TIME_END%60))
printf "${txtrst}================================================================================\\n"
printf "For more information:\\n"
printf "VECTRUM website: https://vectrum.group\\n"
