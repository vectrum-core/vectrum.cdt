...
def main():
    ...
    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            ...
            print('Usage: ./ricardian.py import /eos/contracts/contract/mycontract.abi /eos/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricardian.py export /eos/contracts/contract/mycontract.abi')
