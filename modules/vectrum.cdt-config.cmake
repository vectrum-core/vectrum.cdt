if(VECTRUM_CDT_ROOT STREQUAL "" OR NOT VECTRUM_CDT_ROOT)
   set(VECTRUM_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${VECTRUM_CDT_ROOT}/lib/cmake/vectrum.cdt)
if (NOT VECTRUM_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(VECTRUM_WASM_OLD_BEHAVIOR "On")
    include(VectrumWasmToolchain)
endif()

include(VectrumCDTMacros)
...
function(VECTRUM_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(VECTRUM_CHECK_VERSION)
