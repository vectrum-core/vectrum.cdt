---
content_title: vectrum-cc tool
---

To manually compile the source code, use `vectrum-cc` and `vectrum-ld` as if it were __clang__ and __lld__. All the includes and options specific to VECTRUM and CDT are baked in.

```
USAGE: vectrum-cc [options] <input file> ...
