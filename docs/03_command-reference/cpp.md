---
content_title: vectrum-cpp tool
---

To manually compile the source code, use `vectrum-cpp` and `vectrum-ld` as if it were __clang__ and __lld__. All the includes and options specific to VECTRUM and CDT are baked in.

```
USAGE: vectrum-cpp [options] <input file> ...
