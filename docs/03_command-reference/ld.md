---
content_title: vectrum-ld tool
---

The vectrum-ld tool is a the custom web assembly linker for VECTRUM platform smart contracts.


```
USAGE: vectrum-ld [options] <input file> ...
